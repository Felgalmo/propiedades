...
def get_thermo_properties():
    ...
    pressure_drop = 0.1 * 100000  # 0.1 bar en Pa
    ...
    try:
        ...
        p2_base_pressure = CP.PropsSI('P', 'T', evap_temp_adjusted, 'Q', 1, refrigerant)
        p2_pressure = p2_base_pressure
        ...
        p4_pressure = p3_pressure - pressure_drop
        ...
        p1_base_pressure = CP.PropsSI('P', 'T', evap_temp_adjusted, 'Q', 0, refrigerant)
        p1_pressure = p1_base_pressure
        if evaporator_failure == 'severe':
            p1_pressure *= 1.05
        elif evaporator_failure == 'medium':
            p1_pressure *= 1.03
        ...
        response = {
            ...
            'cop': cop,  # Añadir COP a la respuesta
